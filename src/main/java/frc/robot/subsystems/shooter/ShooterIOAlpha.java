...
public class ShooterIOAlpha implements ShooterIO {
    ...
    public ShooterIOAlpha() {
        topMotor = new TalonFX(RIGHT_SHOOTER_ID, Constants.rioBus);
        bottomMotor = new TalonFX(LEFT_SHOOTER_ID, Constants.rioBus);
        bottomMotor.setControl(new Follower(RIGHT_SHOOTER_ID, MotorAlignmentValue.Opposed));
