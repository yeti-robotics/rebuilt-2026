...
public class IndexerConfigsGamma {
    static final int LEFT_ROLLER_ID = 60;
    static final int RIGHT_ROLLER_ID = 60;
    static final int TOP_CANRANGE_ID = 23;
    public static final double TEST_INDEXER_SPEED = -0.4;
