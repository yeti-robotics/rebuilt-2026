...
public class VisionConstants {
    ...
    public static Transform3d frontCamTrans = new Transform3d(
            new Translation3d(0.286512, 0.030988, 0.258318), new Rotation3d(0, -Math.toRadians(30), Math.toRadians(0)));
    public static Transform3d sideCamTrans = new Transform3d(
            new Translation3d(0.1778, -0.32385, 0.41656), new Rotation3d(0, Math.toRadians(-20), Math.toRadians(90)));
}
