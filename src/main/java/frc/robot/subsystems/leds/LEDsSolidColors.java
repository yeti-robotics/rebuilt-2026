...
public enum LEDsSolidColors {
    ...
    VIVEK_LIME(new SolidColor(7, LEDsConfigs.LED_COUNT - 1).withColor(new RGBWColor(144, 238, 144))),
    AMIT_TEAL(new SolidColor(7, LEDsConfigs.LED_COUNT - 1).withColor(new RGBWColor(89, 255, 232))),
